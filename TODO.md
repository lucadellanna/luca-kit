...
- [ ] Have Italian lawyer review `TERMS-DRAFT.md` and confirm:
  - Art. 1341/1342 two-checkbox mechanism is sufficient
  - EUR liability cap floor amount
  - Specific court city for exclusive forum (clause 19)
...
- [ ] Set up acceptance-record logging (company name, Partita IVA, signatory, timestamp, IP, T&C version) with 10-year retention
