...
**Disclaimer (once per install):** At the very start of the session, before addressing any other request, check if `~/.claude/luca-dev-kit/disclaimer-v1.0-shown` exists. If it does not:
