...
Spawn a Haiku sub-agent to score this run on these criteria (0–10 each), with the instruction: "Score each criterion 0–10. For each criterion, give a one-sentence rationale and name the specific element that most affected the score. Return a markdown table; no preamble.":
